  ...
  <div className='app__footer section__padding'>
    ...
    <div className='app__footer-links'>
      <div className='app__footer-links_contact'>
        ...
        <p className='p__opensans'>basileos georgiou street, Kos Island, 85300, Greece</p>
        <p className='p__opensans'>+30 6948583967</p>
        <p className='p__opensans'>+30 6948583967</p>
      </div>
    ...
    <div className='footer__copyright'>
      <p className='p__opensans'>2022 Aura. All Rights Reserved.</p>
    </div>
  </div>
);
